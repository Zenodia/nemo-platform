...
"""
Sequence packing utilities for training backends.
...
This module is backend-agnostic and can be used by:
- automodel backend
- megatron_bridge backend
...
from nmp.customizer.tasks.training.schemas import TrainingStepConfig
