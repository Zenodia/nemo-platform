...
from .....types.evaluation.benchmark_jobs.results.benchmark_evaluation_result import BenchmarkEvaluationResult
...
class AggregateScoresResource(SyncAPIResource):
    ...
    def download(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/apis/evaluation/v2/workspaces/{workspace}/benchmark-jobs/{job}/results/aggregate-scores/download",
                workspace=workspace,
                job=job,
            ),
            ...
            cast_to=BenchmarkEvaluationResult,
        )
