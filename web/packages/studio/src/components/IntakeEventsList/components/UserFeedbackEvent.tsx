...
interface UserFeedbackEventProps {
  /** The user feedback event to display */
  event: UserFeedbackEventType;
...
/**
 * Renders a user_feedback event in the timeline.
 * Displays thumb in header, and rating/rewrite/opinion/categories as label-value pairs.
 */
export const UserFeedbackEvent: FC<UserFeedbackEventProps> = ({ event, isLast, onDelete }) => {
