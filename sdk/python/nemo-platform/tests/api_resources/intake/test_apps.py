...
class TestApps:
    ...
    def test_raw_response_create(self, client: NeMoPlatform) -> None:
        response = client.intake.apps.with_raw_response.create(
            workspace="workspace",
            name="name",
        )
    ...
    def test_streaming_response_create(self, client: NeMoPlatform) -> None:
        with client.intake.apps.with_streaming_response.create(
            workspace="workspace",
            name="name",
        ) as response:
    ...
    def test_path_params_create(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.intake.apps.with_raw_response.create(
                workspace="",
                name="name",
            )
    ...
    def test_method_retrieve(self, client: NeMoPlatform) -> None:
        app = client.intake.apps.retrieve(
            name="name",
            workspace="workspace",
        )
    ...
    def test_raw_response_retrieve(self, client: NeMoPlatform) -> None:
        response = client.intake.apps.with_raw_response.retrieve(
            name="name",
            workspace="workspace",
        )
    ...
    def test_streaming_response_retrieve(self, client: NeMoPlatform) -> None:
        with client.intake.apps.with_streaming_response.retrieve(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.intake.apps.with_raw_response.retrieve(
                name="name",
                workspace="",
            )
    ...
    def test_method_list(self, client: NeMoPlatform) -> None:
        app = client.intake.apps.list(
            workspace="workspace",
        )
        assert_matches_type(SyncDefaultPagination[App], app, path=["response"])
    ...
    def test_raw_response_list(self, client: NeMoPlatform) -> None:
        response = client.intake.apps.with_raw_response.list(
            workspace="workspace",
        )
    ...
    def test_streaming_response_list(self, client: NeMoPlatform) -> None:
        with client.intake.apps.with_streaming_response.list(
            workspace="workspace",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.intake.apps.with_raw_response.list(
                workspace="",
            )
    ...
    def test_raw_response_delete(self, client: NeMoPlatform) -> None:
        response = client.intake.apps.with_raw_response.delete(
            name="name",
            workspace="workspace",
        )
    ...
    def test_streaming_response_delete(self, client: NeMoPlatform) -> None:
        with client.intake.apps.with_streaming_response.delete(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.intake.apps.with_raw_response.delete(
                name="name",
                workspace="",
            )
    ...
    def test_raw_response_patch(self, client: NeMoPlatform) -> None:
        response = client.intake.apps.with_raw_response.patch(
            name="name",
            workspace="workspace",
        )
    ...
    def test_streaming_response_patch(self, client: NeMoPlatform) -> None:
        with client.intake.apps.with_streaming_response.patch(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_patch(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.intake.apps.with_raw_response.patch(
                name="name",
                workspace="",
            )
...
class TestAsyncApps:
    ...
    async def test_method_create(self, async_client: AsyncNeMoPlatform) -> None:
        app = await async_client.intake.apps.create(
            workspace="workspace",
            name="name",
        )
        assert app is None
    ...
    async def test_raw_response_create(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.intake.apps.with_raw_response.create(
            workspace="workspace",
            name="name",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.intake.apps.with_streaming_response.create(
            workspace="workspace",
            name="name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.intake.apps.with_raw_response.create(
                workspace="",
                name="name",
            )
    ...
    async def test_method_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        app = await async_client.intake.apps.retrieve(
            name="name",
            workspace="workspace",
        )
        assert_matches_type(App, app, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.intake.apps.with_raw_response.retrieve(
            name="name",
            workspace="workspace",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.intake.apps.with_streaming_response.retrieve(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.intake.apps.with_raw_response.retrieve(
                name="name",
                workspace="",
            )
    ...
    async def test_method_list(self, async_client: AsyncNeMoPlatform) -> None:
        app = await async_client.intake.apps.list(
            workspace="workspace",
        )
        assert_matches_type(AsyncDefaultPagination[App], app, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.intake.apps.with_raw_response.list(
            workspace="workspace",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.intake.apps.with_streaming_response.list(
            workspace="workspace",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.intake.apps.with_raw_response.list(
                workspace="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncNeMoPlatform) -> None:
        app = await async_client.intake.apps.delete(
            name="name",
            workspace="workspace",
        )
        assert app is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.intake.apps.with_raw_response.delete(
            name="name",
            workspace="workspace",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.intake.apps.with_streaming_response.delete(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.intake.apps.with_raw_response.delete(
                name="name",
                workspace="",
            )
    ...
    async def test_method_patch(self, async_client: AsyncNeMoPlatform) -> None:
        app = await async_client.intake.apps.patch(
            name="name",
            workspace="workspace",
        )
        assert_matches_type(App, app, path=["response"])
    ...
    async def test_raw_response_patch(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.intake.apps.with_raw_response.patch(
            name="name",
            workspace="workspace",
        )
    ...
    async def test_streaming_response_patch(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.intake.apps.with_streaming_response.patch(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_patch(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.intake.apps.with_raw_response.patch(
                name="name",
                workspace="",
            )
