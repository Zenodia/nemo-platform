...
from ....types.safe_synthesizer.jobs.safe_synthesizer_summary import SafeSynthesizerSummary
...
class ResultsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/apis/safe-synthesizer/v2/workspaces/{workspace}/jobs/{job}/results/{name}",
                workspace=workspace,
                job=job,
                name=name,
            ),
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/apis/safe-synthesizer/v2/workspaces/{workspace}/jobs/{name}/results", workspace=workspace, name=name
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class ResultsResourceWithRawResponse:
    def __init__(self, results: ResultsResource) -> None:
        ...
        self.download_adapter = to_custom_raw_response_wrapper(
            results.download_adapter,
            BinaryAPIResponse,
        )
        self.download_evaluation_report = to_custom_raw_response_wrapper(
            results.download_evaluation_report,
            BinaryAPIResponse,
        )
        self.download_summary = to_raw_response_wrapper(
            results.download_summary,
        )
        self.download_synthetic_data = to_custom_raw_response_wrapper(
            results.download_synthetic_data,
            BinaryAPIResponse,
        )
...
class AsyncResultsResourceWithRawResponse:
    def __init__(self, results: AsyncResultsResource) -> None:
        ...
        self.download_evaluation_report = async_to_custom_raw_response_wrapper(
            results.download_evaluation_report,
            AsyncBinaryAPIResponse,
        )
        self.download_summary = async_to_raw_response_wrapper(
            results.download_summary,
        )
        self.download_synthetic_data = async_to_custom_raw_response_wrapper(
            results.download_synthetic_data,
            AsyncBinaryAPIResponse,
        )
...
class ResultsResourceWithStreamingResponse:
    def __init__(self, results: ResultsResource) -> None:
        ...
        self.download_evaluation_report = to_custom_streamed_response_wrapper(
            results.download_evaluation_report,
            StreamedBinaryAPIResponse,
        )
        self.download_summary = to_streamed_response_wrapper(
            results.download_summary,
        )
        self.download_synthetic_data = to_custom_streamed_response_wrapper(
            results.download_synthetic_data,
            StreamedBinaryAPIResponse,
        )
...
class AsyncResultsResourceWithStreamingResponse:
    def __init__(self, results: AsyncResultsResource) -> None:
        ...
        self.download_evaluation_report = async_to_custom_streamed_response_wrapper(
            results.download_evaluation_report,
            AsyncStreamedBinaryAPIResponse,
        )
        self.download_summary = async_to_streamed_response_wrapper(
            results.download_summary,
        )
        self.download_synthetic_data = async_to_custom_streamed_response_wrapper(
            results.download_synthetic_data,
            AsyncStreamedBinaryAPIResponse,
        )
