...
class TestJobs:
    ...
    def test_method_create(self, client: NeMoPlatform) -> None:
        job = client.intake.exports.jobs.create(
            workspace="workspace",
            config={},
            output_file_url="https://example.com",
        )
        assert_matches_type(ExportJob, job, path=["response"])
    ...
    def test_raw_response_create(self, client: NeMoPlatform) -> None:
        response = client.intake.exports.jobs.with_raw_response.create(
            workspace="workspace",
            config={},
            output_file_url="https://example.com",
        )
    ...
    def test_streaming_response_create(self, client: NeMoPlatform) -> None:
        with client.intake.exports.jobs.with_streaming_response.create(
            workspace="workspace",
            config={},
            output_file_url="https://example.com",
        ) as response:
    ...
    def test_path_params_create(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.intake.exports.jobs.with_raw_response.create(
                workspace="",
                config={},
                output_file_url="https://example.com",
            )
    ...
    def test_method_retrieve(self, client: NeMoPlatform) -> None:
        job = client.intake.exports.jobs.retrieve(
            name="name",
            workspace="workspace",
        )
        assert_matches_type(ExportJob, job, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: NeMoPlatform) -> None:
        response = client.intake.exports.jobs.with_raw_response.retrieve(
            name="name",
            workspace="workspace",
        )
    ...
    def test_streaming_response_retrieve(self, client: NeMoPlatform) -> None:
        with client.intake.exports.jobs.with_streaming_response.retrieve(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.intake.exports.jobs.with_raw_response.retrieve(
                name="name",
                workspace="",
            )
    ...
    def test_method_list(self, client: NeMoPlatform) -> None:
        job = client.intake.exports.jobs.list(
            workspace="workspace",
        )
        assert_matches_type(SyncDefaultPagination[ExportJob], job, path=["response"])
    ...
    def test_raw_response_list(self, client: NeMoPlatform) -> None:
        response = client.intake.exports.jobs.with_raw_response.list(
            workspace="workspace",
        )
    ...
    def test_streaming_response_list(self, client: NeMoPlatform) -> None:
        with client.intake.exports.jobs.with_streaming_response.list(
            workspace="workspace",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.intake.exports.jobs.with_raw_response.list(
                workspace="",
            )
...
class TestAsyncJobs:
    ...
    async def test_method_create(self, async_client: AsyncNeMoPlatform) -> None:
        job = await async_client.intake.exports.jobs.create(
            workspace="workspace",
            config={},
            output_file_url="https://example.com",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.intake.exports.jobs.with_raw_response.create(
            workspace="workspace",
            config={},
            output_file_url="https://example.com",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.intake.exports.jobs.with_streaming_response.create(
            workspace="workspace",
            config={},
            output_file_url="https://example.com",
        ) as response:
    ...
    async def test_path_params_create(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.intake.exports.jobs.with_raw_response.create(
                workspace="",
                config={},
                output_file_url="https://example.com",
            )
    ...
    async def test_method_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        job = await async_client.intake.exports.jobs.retrieve(
            name="name",
            workspace="workspace",
        )
        assert_matches_type(ExportJob, job, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.intake.exports.jobs.with_raw_response.retrieve(
            name="name",
            workspace="workspace",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.intake.exports.jobs.with_streaming_response.retrieve(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.intake.exports.jobs.with_raw_response.retrieve(
                name="name",
                workspace="",
            )
    ...
    async def test_method_list(self, async_client: AsyncNeMoPlatform) -> None:
        job = await async_client.intake.exports.jobs.list(
            workspace="workspace",
        )
        assert_matches_type(AsyncDefaultPagination[ExportJob], job, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.intake.exports.jobs.with_raw_response.list(
            workspace="workspace",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.intake.exports.jobs.with_streaming_response.list(
            workspace="workspace",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.intake.exports.jobs.with_raw_response.list(
                workspace="",
            )
