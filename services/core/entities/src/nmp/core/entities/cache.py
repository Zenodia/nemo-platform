...
"""In-process TTL LRU cache (vendored from cachetools 7.0.5).

The MIT License applies to the original cachetools project:
https://github.com/tkem/cachetools

Only ``TTLCache`` and its private dependencies are included.
"""
