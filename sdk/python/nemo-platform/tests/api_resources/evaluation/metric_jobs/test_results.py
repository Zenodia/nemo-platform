...
class TestResults:
    ...
    def test_raw_response_retrieve(self, client: NeMoPlatform) -> None:
        response = client.evaluation.metric_jobs.results.with_raw_response.retrieve(
            name="name",
            workspace="workspace",
            job="job",
        )
    ...
    def test_streaming_response_retrieve(self, client: NeMoPlatform) -> None:
        with client.evaluation.metric_jobs.results.with_streaming_response.retrieve(
            name="name",
            workspace="workspace",
            job="job",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.evaluation.metric_jobs.results.with_raw_response.retrieve(
                name="name",
                workspace="",
                job="job",
            )
    ...
    def test_method_list(self, client: NeMoPlatform) -> None:
        result = client.evaluation.metric_jobs.results.list(
            name="name",
            workspace="workspace",
        )
    ...
    def test_raw_response_list(self, client: NeMoPlatform) -> None:
        response = client.evaluation.metric_jobs.results.with_raw_response.list(
            name="name",
            workspace="workspace",
        )
    ...
    def test_streaming_response_list(self, client: NeMoPlatform) -> None:
        with client.evaluation.metric_jobs.results.with_streaming_response.list(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.evaluation.metric_jobs.results.with_raw_response.list(
                name="name",
                workspace="",
            )
    ...
    def test_method_download(self, client: NeMoPlatform, respx_mock: MockRouter) -> None:
        respx_mock.get("/apis/evaluation/v2/workspaces/workspace/metric-jobs/job/results/name/download").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        result = client.evaluation.metric_jobs.results.download(
            name="name",
            workspace="workspace",
            job="job",
        )
    ...
    def test_raw_response_download(self, client: NeMoPlatform, respx_mock: MockRouter) -> None:
        ...
        result = client.evaluation.metric_jobs.results.with_raw_response.download(
            name="name",
            workspace="workspace",
            job="job",
        )
    ...
    def test_streaming_response_download(self, client: NeMoPlatform, respx_mock: MockRouter) -> None:
        ...
        with client.evaluation.metric_jobs.results.with_streaming_response.download(
            name="name",
            workspace="workspace",
            job="job",
        ) as result:
    ...
    def test_path_params_download(self, client: NeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            client.evaluation.metric_jobs.results.with_raw_response.download(
                name="name",
                workspace="",
                job="job",
            )
...
class TestAsyncResults:
    ...
    async def test_method_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        result = await async_client.evaluation.metric_jobs.results.retrieve(
            name="name",
            workspace="workspace",
            job="job",
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.evaluation.metric_jobs.results.with_raw_response.retrieve(
            name="name",
            workspace="workspace",
            job="job",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.evaluation.metric_jobs.results.with_streaming_response.retrieve(
            name="name",
            workspace="workspace",
            job="job",
        ) as response:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.evaluation.metric_jobs.results.with_raw_response.retrieve(
                name="name",
                workspace="",
                job="job",
            )
    ...
    async def test_method_list(self, async_client: AsyncNeMoPlatform) -> None:
        result = await async_client.evaluation.metric_jobs.results.list(
            name="name",
            workspace="workspace",
        )
        assert_matches_type(PlatformJobListResultResponse, result, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncNeMoPlatform) -> None:
        response = await async_client.evaluation.metric_jobs.results.with_raw_response.list(
            name="name",
            workspace="workspace",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncNeMoPlatform) -> None:
        async with async_client.evaluation.metric_jobs.results.with_streaming_response.list(
            name="name",
            workspace="workspace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.evaluation.metric_jobs.results.with_raw_response.list(
                name="name",
                workspace="",
            )
    ...
    async def test_method_download(self, async_client: AsyncNeMoPlatform, respx_mock: MockRouter) -> None:
        ...
        result = await async_client.evaluation.metric_jobs.results.download(
            name="name",
            workspace="workspace",
            job="job",
        )
    ...
    async def test_raw_response_download(self, async_client: AsyncNeMoPlatform, respx_mock: MockRouter) -> None:
        ...
        result = await async_client.evaluation.metric_jobs.results.with_raw_response.download(
            name="name",
            workspace="workspace",
            job="job",
        )
    ...
    async def test_streaming_response_download(self, async_client: AsyncNeMoPlatform, respx_mock: MockRouter) -> None:
        ...
        async with async_client.evaluation.metric_jobs.results.with_streaming_response.download(
            name="name",
            workspace="workspace",
            job="job",
        ) as result:
    ...
    async def test_path_params_download(self, async_client: AsyncNeMoPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace` but received ''"):
            await async_client.evaluation.metric_jobs.results.with_raw_response.download(
                name="name",
                workspace="",
                job="job",
            )
