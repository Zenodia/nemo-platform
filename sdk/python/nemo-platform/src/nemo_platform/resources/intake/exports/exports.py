...
class ExportsResource(SyncAPIResource):
    ...
    def preview(
        ...
        *,
        ...
        return self._post(
            path_template("/apis/intake/v2/workspaces/{workspace}/export/preview", workspace=workspace),
...
class ExportsResourceWithRawResponse:
    ...
    def jobs(self) -> JobsResourceWithRawResponse:
        return JobsResourceWithRawResponse(self._exports.jobs)
...
class AsyncExportsResourceWithRawResponse:
    ...
    def jobs(self) -> AsyncJobsResourceWithRawResponse:
        return AsyncJobsResourceWithRawResponse(self._exports.jobs)
...
class ExportsResourceWithStreamingResponse:
    ...
    def jobs(self) -> JobsResourceWithStreamingResponse:
        return JobsResourceWithStreamingResponse(self._exports.jobs)
...
class AsyncExportsResourceWithStreamingResponse:
    ...
    def jobs(self) -> AsyncJobsResourceWithStreamingResponse:
        return AsyncJobsResourceWithStreamingResponse(self._exports.jobs)
