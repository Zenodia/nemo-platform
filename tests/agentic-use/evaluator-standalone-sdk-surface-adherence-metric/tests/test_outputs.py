...
from task_metrics import SurfaceAdherenceMetricAuthoringMetric


def test_agent_attempt_scores_with_evaluator_sdk():
    verify_agent_attempt_scores_with_evaluator_sdk(task_specific_metrics=[SurfaceAdherenceMetricAuthoringMetric()])
