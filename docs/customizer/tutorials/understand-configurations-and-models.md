...
!!! note "The time to complete this tutorial is approximately 15 minutes."
...
A **Model Entity** represents a model registered in the {{platform_name}}. It contains:
...
-   **[Format Training Dataset](format-training-dataset.md)**

    ---

    Learn how to prepare your data for fine-tuning.

-   **[Start a LoRA Job](lora-customization-job.ipynb)**

    ---

    Create a parameter-efficient LoRA adapter.

-   **[Start a Full SFT Job](sft-customization-job.ipynb)**

    ---

    Use full supervised fine-tuning for maximum performance.

-   **[Import Custom Models](import-hf-model.md)**
