...
__all__ = ["ResponseGroundednessMetricResponse", "JudgeModel"]

JudgeModel: TypeAlias = Union[Model, ModelRef]


class ResponseGroundednessMetricResponse(BaseModel):
    ...
    type: Optional[Literal["response_groundedness"]] = None
