# Troubleshooting {{platform_name}} Deployment on Kubernetes

Use this documentation to troubleshoot issues that can arise while you deploy and run the {{platform_name}} on Kubernetes.
