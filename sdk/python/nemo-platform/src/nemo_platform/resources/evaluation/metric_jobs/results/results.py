...
class ResultsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/apis/evaluation/v2/workspaces/{workspace}/metric-jobs/{job}/results/{name}",
                workspace=workspace,
                job=job,
                name=name,
            ),
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/apis/evaluation/v2/workspaces/{workspace}/metric-jobs/{name}/results", workspace=workspace, name=name
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def download(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/apis/evaluation/v2/workspaces/{workspace}/metric-jobs/{job}/results/{name}/download",
                workspace=workspace,
                job=job,
                name=name,
            ),
