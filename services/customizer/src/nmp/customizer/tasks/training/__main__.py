...
Usage:
    python -m nmp.customizer.tasks.training

Note: This entry point is the same across all training container images.
The backend is determined by the CUSTOMIZER_TRAINING_BACKEND_TYPE environment
variable baked into each image.
