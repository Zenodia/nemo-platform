 ...
 * Nemo Platform API
 */
import type { CreateModelProviderRequestDefaultExtraBody } from './CreateModelProviderRequestDefaultExtraBody';
import type { CreateModelProviderRequestDefaultExtraHeaders } from './CreateModelProviderRequestDefaultExtraHeaders';
import type { CreateModelProviderRequestRequiredExtraBody } from './CreateModelProviderRequestRequiredExtraBody';
import type { CreateModelProviderRequestRequiredExtraHeaders } from './CreateModelProviderRequestRequiredExtraHeaders';
...
export interface CreateModelProviderRequest {
  ...
  default_extra_body?: CreateModelProviderRequestDefaultExtraBody;
  /** Default headers for inference requests. Can be overridden by user requests. */
  default_extra_headers?: CreateModelProviderRequestDefaultExtraHeaders;
  /** Required body parameters for inference requests. Cannot be overridden by user requests. */
  required_extra_body?: CreateModelProviderRequestRequiredExtraBody;
  /** Required headers for inference requests. Cannot be overridden by user requests. */
  required_extra_headers?: CreateModelProviderRequestRequiredExtraHeaders;
  /**
