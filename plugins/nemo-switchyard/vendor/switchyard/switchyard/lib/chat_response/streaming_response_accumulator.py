...
class _OpenAIChatStreamAccumulator:
    ...
    def as_response(self) -> CompletionChatResponse:
        ...
        return CompletionChatResponse(response)
...
class _AnthropicStreamAccumulator:
    ...
    def as_response(self) -> AnthropicChatResponse:
        ...
        return AnthropicChatResponse(response)
...
class _ResponsesStreamAccumulator:
    ...
    def as_response(self) -> ResponsesApiChatResponse:
        if isinstance(self._final_response, OpenAIResponse):
            return ResponsesApiChatResponse(self._final_response)
        ...
        return ResponsesApiChatResponse(response)
