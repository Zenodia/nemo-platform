...
from .output_rails_streaming_config_param import OutputRailsStreamingConfigParam

__all__ = ["OutputRailsParam"]


class OutputRailsParam(TypedDict, total=False):
    ...
    streaming: OutputRailsStreamingConfigParam
