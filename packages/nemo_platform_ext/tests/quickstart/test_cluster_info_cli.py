...
class TestClusterInfo:
    ...
    def test_platform_status_displayed(
        ...
        with (
            patch("nemo_platform_ext.cli.core.context.CLIContext.get_base_url", return_value=_BASE_URL),
    ...
    def test_trailing_slash_in_url_does_not_cause_double_slash(
        ...
        with (
            patch("nemo_platform_ext.cli.core.context.CLIContext.get_base_url", return_value=base_url),
...
class TestQuickstartInfo:
    def test_docker_unavailable_exits_one(
        ...
        with patch("nemo_platform_ext.quickstart.QuickstartCluster", return_value=mock_cluster):
