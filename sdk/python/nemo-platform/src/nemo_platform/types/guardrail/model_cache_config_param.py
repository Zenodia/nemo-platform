...
from .cache_stats_config_param import CacheStatsConfigParam

__all__ = ["ModelCacheConfigParam"]


class ModelCacheConfigParam(TypedDict, total=False):
