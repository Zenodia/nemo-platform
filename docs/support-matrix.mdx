...
description: ""
---
This matrix defines the supported OSS local-install target for NeMo Platform 0.2.0. It applies to the Python package, CLI, SDK, and local services started by `nemo setup`.

Docker Compose, Helm, Kubernetes, and OpenShift deployment paths are not part of the OSS 0.2.0 documentation scope.
...
The following are not part of the OSS 0.2.0 local support matrix:
