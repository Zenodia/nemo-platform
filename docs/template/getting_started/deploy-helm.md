...
Since helm is deploying a container, we recommend that you become familiar with the general information in
[Deploying with Docker](./deploy-docker) before using helm and Kubernetes.
...
## Launching <microservice> in Kubernetes
