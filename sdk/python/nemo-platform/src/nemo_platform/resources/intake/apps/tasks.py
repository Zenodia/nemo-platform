...
from ....types.intake.apps import TaskSortField, task_list_params, task_patch_params, task_create_params
...
class TasksResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          project: The name of the project associated with this task
        ...
        return self._post(
            path_template(
                "/apis/intake/v2/workspaces/{workspace}/apps/{path_name}/tasks",
                workspace=workspace,
                path_name=path_name,
            ),
    ...
    def list(
        ...
        *,
        ...
        Args:
          filter: Filter tasks by name, app, description, project, created_at, and updated_at.
        ...
        return self._get_api_list(
            path_template("/apis/intake/v2/workspaces/{workspace}/apps/{name}/tasks", workspace=workspace, name=name),
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform(
                ...
                task_patch_params.TaskPatchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
