...
__all__ = ["NeMoAgentToolkitRemoteMetricParam"]


class NeMoAgentToolkitRemoteMetricParam(BaseModel):
    """Request type for NemoAgentToolkitRemoteMetric.
    ...
    type: Optional[Literal["nemo-agent-toolkit-remote"]] = None
