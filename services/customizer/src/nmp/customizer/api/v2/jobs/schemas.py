...
from nmp.customizer.entities.validators import validate_fileset_uri
from nmp.customizer.entities.values import FinetuningType, OutputNameType, Precision
...
class _CustomizationJobBase(BaseModel):
    ...
    dataset: Annotated[str, AfterValidator(validate_fileset_uri)] = Field(
        description="Dataset URI. Supported protocol: fileset:// (e.g., fileset://workspace/name)."
    )
