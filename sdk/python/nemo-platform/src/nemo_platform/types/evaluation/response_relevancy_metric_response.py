...
__all__ = ["ResponseRelevancyMetricResponse", "EmbeddingsModel", "JudgeModel"]
...
class ResponseRelevancyMetricResponse(BaseModel):
    ...
    type: Optional[Literal["response_relevancy"]] = None
